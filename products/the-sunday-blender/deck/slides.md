...
# 背景 3: 为什么做 The Sunday Blender (TSB)
...
- 人工完成图片的收集
- 如何应对 AI 幻觉？
  - 三个 LLM 模型交叉验证 （Claude, Gemini, chatGPT)
  - 人工`直觉`，`经验`和`常识`依旧重要
  - 幻觉无法 100% 根治
  - 产品定位：是`教育`，不是新闻
...
- HTML => PDF (10 seconds)
  - [Python 脚本](https://github.com/Inturious-Labs/sundayblender/blob/main/scripts/html_to_pdf.py)自动将 HTML 网页转化为可读性更高，适合打印的 PDF
- PDF => MP3 (5 minutes)
  - [Google NotebookLM](https://notebooklm.google.com) 自动将 PDF 转化为美式英语原声 AI 主理人解读的播客
...
- PDF => MP4 （10 minutes)
  - Google NotebookLM 自动将 PDF 转化为 PPT 风格的视频 + 英文原声 AI 主理人解读
  - [Youtube 频道](https://www.youtube.com/@TheSundayBlender)发布
- 语言不再是障碍
</v-clicks>
...
- 用 Python 脚本不稀奇；一个没有 CS 背景的人大量使用 Python 脚本非常稀奇
- （几乎）没有做不到的，只有想不到的
...
| 内容创建者 | 收集数据，整理数据，编辑内容，分享内容，构建叙事 | 100-1000x |


- 体验: https://weekly.sundayblender.com
- 联系: clayton.man@sundayblender.com
